  ...
  var fn = {
    ...
    Apps: function () {
      ...
      $("#filteredSizeChoice").on('click', ".sizeoptions", function () {
        ...
        $('#sizechoice').text(radioValue);
        $("#quantityElements").attr("style", "display:block");
      });


      $(".coloroptions").on('click', function () {
        var radioValue = $(this).attr('value');
        $('#colorchoice').text(radioValue);
      });
      ...
      $('.rangeslider').each(function () {
        ...
        var options = {
          ...
          onFinish: function (data) {
            ...
            var _filterObj = {};
            var _minPrice = data.from;
            var _maxPrice = data.to;
      ...
      $(document).ready(function () {
        ...
        $('.counter-plus').click(function () {
          var fieldID = $(this).attr('field'),
            ...
            fieldMax = parseInt($('input[name=' + fieldID + ']').attr("max"));

          if (!isNaN(fieldVal) && fieldVal < fieldMax) {
            $('input[name=' + fieldID + ']').val(fieldVal + 1);
          } else {
            $('input[name=' + fieldID + ']').val(fieldMax);
          }

          var SKU = this.dataset.product;
          var quantity = $('input[name=' + fieldID + ']').val();
